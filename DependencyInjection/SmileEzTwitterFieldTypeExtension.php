...
namespace Smile\EzTwitterFieldTypeBundle\DependencyInjection;
...
class SmileEzTwitterFieldTypeExtension extends Extension implements PrependExtensionInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $container->prependExtensionConfig('assetic', array('bundles' => array('SmileEzTwitterFieldTypeBundle')));
    ...
    private function prependYui(ContainerBuilder $container)
    {
        $container->setParameter(
            'smile_twitterfieldtype.public_dir',
            'bundles/smileeztwitterfieldtype'
        );
